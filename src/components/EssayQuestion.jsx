    ...
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 p-6">
      ...
      <div className="mb-4">
        <div className="flex items-start gap-3 mb-3">
          <div className="flex-shrink-0 w-8 h-8 bg-purple-100 rounded-full flex items-center justify-center">
            <span className="text-purple-600 font-bold text-sm">{questionIndex + 1}</span>
          </div>
      ...
      {!isSubmitted && (
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-start gap-2">
            ...
            <div className="flex-1">
              <p className="text-sm text-blue-800 font-medium mb-1">💡 Gợi ý:</p>
      ...
      {isSubmitted && question.answer && (
        <div className="bg-green-50 border border-green-200 rounded-lg p-4 mt-4">
          ...
          <p className="text-green-800 text-sm whitespace-pre-wrap">{question.answer}</p>
        </div>
      )}
    </div>
  )
