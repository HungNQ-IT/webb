...
function Navbar() {
  ...
  const navLinks = [
    ...
    { key: 'documents', path: '/documents', label: 'Tài liệu' },
  ...
  const adminLinks = user?.role === 'admin' ? [
    { key: 'admin', path: '/admin', label: '⚙️ Admin', highlight: true }
  ] : []
              ...
              return (
                <Link
                  ...
                  className={`relative py-5 transition-colors ${
                    link.highlight 
                      ? 'text-orange-600 dark:text-orange-400 hover:text-orange-700 dark:hover:text-orange-300 font-bold' 
                      : isActive 
                        ? 'text-primary-base' 
                        : 'text-neutral-600 dark:text-neutral-300 hover:text-primary-base dark:hover:text-primary-400'
                  }`}
                >
                  {link.label}
                  {isActive && (
